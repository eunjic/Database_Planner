 	...
 	if ($res) { 
 		...
 		echo "<style>
		  ...
		  while ($newArray = mysqli_fetch_array($res, MYSQLI_ASSOC)){
			...
			echo "<TD><input type=text class='form-control m-1' name=time value='".$time."'></TD>";
			echo "<TD><input type=text class='form-control m-1' name=day value='".$day."'></TD>";
			echo "<TD><input type=text class='form-control m-1' name=todo value='".$todo."'></TD>";
			echo '<TD><input type=submit class="btn btn-outline-dark m-1" value="수정"></TD>';	
			echo "<TR>\n"; 
			echo "</FORM>\n";
